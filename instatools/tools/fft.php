    ...
    do {
        ...
        for($i = 0; $i < count($listids); $i++):
            ...
            if($priv == 1):
                ...
                //comment media
                $listKomentar = array("Like back dan Follow back ya🙏", "follback dan like back🙏", "follback ya👌", "salken", " follback dan like back ya👍", "salam kenal follback dan likeback ya kak👍", "orang mana? follback dan likeback ya👍", "salken ya", " boleh minta follback dan likeback?", "follback yo", "follbackk", "followback ya", "udah aku follow dan like bisa minta follback dan likeback gak hehe", "follback dan likeback yo kak udah difollow kok", "follback dan likeback kak sudah aku follow dan like", "bisa minta follow back kak hehe?", "followback yo 😀", "salken", " follback ya 🙂 ", "salken", " follback aku yah", "salken", " btw follback ya", "salken", " follback juga yah hehe", "salamkenal", " follback yah hehe", "bisa follback ?", "follback yow", "follback yapp", "Follback hihihihi", "follbackk saya ya 🙂", "Orang mana kak, follback ya", " like back dan Follback ya", "Salam kenal kak hehe likeback dan follback ya", "Salkus ya kak like back dan follback ya", "Mari berteman kak", "like back dan follback ya", "Orang mana kak, follback dong", " Salam kenal ya tod ", " likeback dan Follback yaa", "Orang mana kak, bisa saling follow ya?", " likeback dan Follback dong", "Namanya siapa, follback dong", " Salam kenal ya", " like back dan follback ya", "Saling follback ya kak", " makasih", "Orang mana kak, follback ya", " likeback dan Follbackdong hehehe", "halo  kak salken ya", "follback kaka", " like back dan Follback ya", "Mari berteman ya kak saling dan follback hehe", "Kenalan dong kak heheh likeback dan follback ya", "Likeback dan follback hihi salam kenal ya", "Hallo kak salam kenal ya hehe likeback dan follback juga ya");
